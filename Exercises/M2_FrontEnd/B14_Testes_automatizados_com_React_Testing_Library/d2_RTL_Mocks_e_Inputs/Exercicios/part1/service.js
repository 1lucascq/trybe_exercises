...
const talkLOUDER = (string) => string.toUpperCase();

const returnFirstLetter = (string) => string.slice(0, 1)

const concatenateStrings = (stringA, stringB) => stringA.concat(stringB)
