...
// Acesso a método com getter para manipular atributo privado como se fosse público o _age continua igual
console.log(p2.age);
// Acesso a método público que manipula atributo privado
p2.birthday();
console.log(p2.age);
// Acesso a método com setter para manipular atributo privado como se fosse público o _age continua igual
p2.age = 17;
console.log(p2.age);
// Leitura de atributo readonly
console.log(p1.height);
// Vendo a validação da alteração da idade
p2.age = 300;
console.log(p2.age);
// Saída: 17
