...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.ok(objetoRetornado.fetchMenu);
    // ```
    ...
    // ```
    const objetoRetornado3 = createMenu({objeto: 'Qualquer'});
    assert.deepStrictEqual(objetoRetornado3.fetchMenu(), {objeto: 'Qualquer'});// Retorno: { food: {}, drink: {}}
    // ```
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 5: Verifique se chamar uma função associada à chave `order` no objeto retornado, passando uma string como parâmetro, 
    ...
    // --------------------------------------------------------------------------------------
    // TESTE 6: Verifique se os três orders seguintes, de bebidas e comidas mescladas, somam três itens no array `objetoRetornado.consumption` conforme os itens pedidos.
    // ```
    const objetoRetornado6 = createMenu({objeto: 'Qualquer'});
    ...
    // ```
    const objetoRetornado7 = createMenu({objeto: 'Qualquer'});
    ...
    assert.deepStrictEqual(objetoRetornado8.pay(), somaDosPreçosDosPedidos);
